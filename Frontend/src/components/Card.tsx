...
const Card = () => {
  return (
    <div style={{ boxShadow: `0px 0px 10px ${hexToRgba("#4B63E6", 0.5)}` }} className=" w-full    bg-[#4B63E6] aspect-[9/5] rounded-2xl relative ">
      ...
      <div className=" flex flex-col p-6 justify-between items-start w-full h-full overflow-hidden">
        <div className=" flex justify-between items-start w-full ">
          <div className="text-xl font-bold mb-2 text-surface"> Amir wais account</div> <img className="w-7" src={nfc} alt="" />
        </div>
